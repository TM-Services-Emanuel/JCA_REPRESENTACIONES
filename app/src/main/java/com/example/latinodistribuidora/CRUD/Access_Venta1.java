...
public class Access_Venta1 {
    ...
    public Cursor getv_ventaServer(){
        this.openReadable();
        registros = db.rawQuery("Select * from v_ventas1 where sync='N'", null);
        return registros;
    }
    ...
    public Cursor getDetalleSync(){
        this.openWritable();
        registros = db.rawQuery("Select * from detalleventa1 where sync='N'", null);
        return registros;
    }
    ...
    public void actualizarSync(){
        this.openWritable();
        db.execSQL("UPDATE ventas_1 SET sync='S'  WHERE sync ='N'");
    }

    public void actualizarDSync(){
        this.openWritable();
        db.execSQL("UPDATE detalleventa1 SET sync='S'  WHERE sync ='N'");
    }
